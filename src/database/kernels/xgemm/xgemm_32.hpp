  ...
  "Xgemm", Precision::kSingle, {"GEMMK", "KREG", "KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        { "default", {
          ...
          { Name{"Intel(R) Core(TM) i5-6400 CPU @ 2.70GHz           "}, Params{ 0, 1, 32, 2, 16, 32, 32, 16, 8, 64, 0, 1, 0, 1, 1, 4 } },
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        ...
        { "SM7.5", {
          { Name{"GeForce RTX 2070 SUPER                            "}, Params{ 0, 1, 16, 2, 32, 8, 128, 32, 16, 128, 1, 1, 1, 0, 4, 1 } },
        ...
        { "SM8.6", {
          { Name{"NVIDIA GeForce RTX 3070                           "}, Params{ 0, 1, 32, 2, 8, 8, 32, 8, 16, 128, 1, 1, 0, 1, 4, 4 } },
          { Name{"NVIDIA GeForce RTX 3090 Ti                        "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 1, 1, 0, 0, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 32, 8, 16, 128, 1, 1, 0, 1, 4, 4 } },
        } },
        { "default", {
